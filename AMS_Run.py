...
window = tk.Tk()
window.title("GRAPHIC ERA UNIVERSITY")
    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:\Attendance Project\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = 'C:\Attendance Project/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:\Attendance Project\-------Check atttendance-------"')
...
message = tk.Label(window, text="GRAPHIC ERA UNIVERSITY\nFace Recognition Based Attendance Management System", bg="black", fg="white", width=50,
